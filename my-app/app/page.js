    ...
    <div className="bg-gray-50 text-gray-800 min-h-screen">
      ...
      <section className="relative bg-gradient-to-r from-blue-500 via-cyan-400 to-teal-400 text-white py-40 text-center overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <button className="bg-white text-teal-500 px-8 py-3 rounded-md font-semibold hover:bg-gray-200 transition transform hover:scale-105">
            Shop Now
          </button>
        </div>
      </section>
      ...
      <section className="px-8 py-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-10">
          {products.map((p) => (
            <div key={p.id} className="bg-white shadow-xl rounded-lg overflow-hidden hover:scale-105 transform transition duration-300">
              ...
              <div className="p-6 text-center">
                ...
                <p className="text-teal-500 font-bold text-lg mb-4">{p.price}</p>
                <button className="mt-2 w-full bg-teal-500 text-white py-3 rounded-md hover:bg-teal-600 transition">
                  Add to Cart
                </button>
              </div>
            </div>
      ...
      <section className="bg-gradient-to-r from-teal-500 via-cyan-400 to-blue-500 py-24 text-center text-white relative overflow-hidden">
        <div className="relative z-10">
          ...
          <div className="flex justify-center flex-wrap gap-2 md:gap-4">
            ...
            <button className="bg-white text-teal-500 px-6 py-3 rounded-r-md font-semibold hover:bg-gray-200 hover:text-teal-600 transition">
              Subscribe
            </button>
          </div>
        </div>
